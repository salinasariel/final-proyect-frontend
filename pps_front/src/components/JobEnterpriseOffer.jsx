                ...
                <div className="flex w-full items-center justify-between border-b pb-3">
                    ...
                    <div className="flex items-center space-x-2">
                        <button
                            ...
                            className="rounded-2xl border bg-neutral-100 px-3 py-1 text-xs font-semibold hover:bg-[#9acd32] hover:text-white"
                        >
                        ...
                        <button
                            onClick={deleteOffer}
                            className="rounded-2xl border bg-neutral-100 px-3 py-1 text-xs font-semibold hover:bg-[#c30010] hover:text-white"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
