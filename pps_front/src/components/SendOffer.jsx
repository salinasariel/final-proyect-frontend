  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="scale-up-vertical-center flex justify-center items-center flex-1 p-4">
        <div className="w-full max-w-4xl bg-white dark:bg-stone-900 dark:border-none dark:text-white rounded-xl border p-5 shadow-md">
          <div className="flex w-full items-center justify-between border-b pb-3">
            <div className="flex items-center gap-2">
              <b>
                ¿Está seguro de aplicar en {empresName} para el puesto de{" "}
                {title}?
              </b>
            </div>
          ...
          <div className="mt-4 mb-6">
            <div className="flex justify-end mt-4">
              <button
                onClick={sendOffer}
                className="rounded-2xl border bg-neutral-100 dark:border-none dark:bg-neutral-800 px-8 py-2 text-xs font-semibold hover:bg-[#00ADB5] hover:text-white"
              >
                Sí, aplicar
              </button>
            </div>
