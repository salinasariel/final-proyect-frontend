            ...
            <div style={{ flex: 1 }}>
                <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
                    <div className="bg-white shadow-md rounded-lg p-8 max-w-md scale-up-center">
                        <h1 className="text-3xl font-bold text-center mb-4">Inicio de Sesión</h1>
                        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                            <div className="flex flex-col">
                                <label htmlFor="email" className="font-semibold">Acceso</label>
                                <input
                                    id="email"
                                    type="text"
                            ...
                            <div className="flex flex-col">
                                <label htmlFor="password" className="font-semibold">Clave</label>
                                <input
                                    id="password"
                                    type="password"
